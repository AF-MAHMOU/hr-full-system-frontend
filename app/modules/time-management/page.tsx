...
export default function TimeManagementPage() {
    ...
    <div className={s.container}>
        ...
        <Link href={attendanceCorrectionHref} className={s.button}>
            Attendance Correction
        </Link>
        <Link href={attendanceRecordHref} className={s.button}>
            Attendance Record
        </Link>
        <Link href={holidayHref} className={s.button}>
            Holidays
        </Link>
        <Link href={latenessHref} className={s.button}>
            Lateness
        </Link>
        <Link href={notificationHref} className={s.button}>
            Notifications
        </Link>
        <Link href={overtimeHref} className={s.button}>
            Overtime
        </Link>
        <Link href={scheduleRuleHref} className={s.button}>
            Schedule
        </Link>
        <Link href={shiftHref} className={s.button}>
            Shifts
        </Link>
        <Link href={timeExceptionHref} className={s.button}>
            Time Exception
        </Link>        
    </div>
